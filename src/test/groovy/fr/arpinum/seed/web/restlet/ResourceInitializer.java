...
public class ResourceInitializer {
    ...
    public static ResourceInitializer with(ServerResource resource) {
        return new ResourceInitializer(resource);
    }
    ...
    public ResourceInitializer withParam(String key, Object value) {
